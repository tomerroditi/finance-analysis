...
|------|----------|---------|------------|
| `default_credentials.yaml` | `backend/resources/` | Empty template for credentials | ❌ (in git) |
| `credentials.yaml` | `~/.finance-analysis/` | User's actual credentials | ✅ (via UI) |
| `default_categories.yaml` | `backend/resources/` | Default category/tag hierarchy | ❌ (in git) |
| `categories.yaml` | `~/.finance-analysis/` | User's categories | ✅ (via UI) |
| `categories_icons.yaml` | `backend/resources/` | Emoji icons for categories | ✅ (via UI) |
| `test_credentials.yaml` | `backend/resources/` | Test account creds | ❌ (gitignored) |
